...
x0 = [0.0, 0.0] 
history_x = run_bfgs_experiment(x0)
...
plot!(p1, X_hist, Y_hist, color=:red, linewidth=2.5, marker=:circle, markersize=4, label="BFGS ($n_iters iterations)")
...
savefig(p1, "bfgs_rosenbrock.pdf")
println("Successfully saved 'bfgs_rosenbrock.pdf'. Iterations: ", n_iters)