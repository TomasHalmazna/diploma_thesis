...
p = contour(x_range, y_range, Z, levels=10 .^ range(-1, 3.5, length=40), 
            ...
            xlim=(-0.25, 1.25), ylim=(-0.25, 1.25), legend=:topleft)

plot!(p, X_hist, Y_hist, color=:red, linewidth=2.0, marker=:circle, markersize=4, label="Steepest Descent (first 20 steps)")
