...
const modalContent = {
    function: {
        ...
        goldstein_price: { title: "Goldstein-Price Function", body: `<p>A complex polynomial with several local minima.</p><div class="formula-box">$$f(x,y) = \\left[1 + (x+y+1)^2(19-14x+3x^2-14y+6xy+3y^2)\\right] \\\\ \\times \\left[30 + (2x-3y)^2(18-32x+12x^2+48y-36xy+27y^2)\\right]$$</div><p><strong>Global Minimum:</strong> \\(f(\\mathbf{x}^*) = 3\\) at \\(\\mathbf{x}^* = (0, -1)\\)</p><p><strong>Source:</strong> <a href="https://www.sfu.ca/~ssurjano/goldpr.html" target="_blank">SFU Library</a></p>` },
        matyas: { title: "Matyas Function", body: `<p>A plate-shaped convex function.</p><div class="formula-box">$$f(x,y) = 0.26(x^2 + y^2) - 0.48xy$$</div><p><strong>Global Minimum:</strong> \\(f(\\mathbf{x}^*) = 0\\) at \\(\\mathbf{x}^* = (0, 0)\\)</p><p><strong>Source:</strong> <a href="https://www.sfu.ca/~ssurjano/matya.html" target="_blank">SFU Library</a></p>` },
        levi_n13: { title: "Lévi Function N.13", body: `<p>A highly multimodal function due to the trigonometric components.</p><div class="formula-box">$$f(x,y) = \\sin^2(3\\pi x) + (x-1)^2[1 + \\sin^2(3\\pi y)] + (y-1)^2[1 + \\sin^2(2\\pi y)]$$</div><p><strong>Global Minimum:</strong> \\(f(\\mathbf{x}^*) = 0\\) at \\(\\mathbf{x}^* = (1, 1)\\)</p><p><strong>Source:</strong> <a href="https://www.sfu.ca/~ssurjano/levin13.html" target="_blank">SFU Library</a></p>` },
